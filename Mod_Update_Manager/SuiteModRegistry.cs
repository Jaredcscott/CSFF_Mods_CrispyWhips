...
namespace mod_update_manager
{
    ...
    public static class SuiteModRegistry
    {
        ...
        public static readonly List<SuiteModEntry> All = new List<SuiteModEntry>
        {
            ...
            new SuiteModEntry { FolderName="Homestead_Perks",             DisplayName="Homestead Perks",             Category="Content",   Description="Thirteen character-creation perks granting placeable structure kits — Homestead, Cabin, Mud Hut, Well, Cellar, Log Bed, Furnace, Forge, Oven, Rain Cistern, Tanning Pit, Pit Trap, and Path kits." },
