...
public static class Reflect
{
    ...
    public static object GetMember(object instance, params string[] names)
    {
        ...
        foreach (var name in names)
        {
            ...
            catch (Exception ex) { Log.Debug($"Reflect.GetMember: read failed for member '{name}' on {t.Name}: {Log.ExceptionText(ex)}"); }
        }
        return null;
    }
    ...
    public static bool TryGetMember(object instance, string name, out object value)
    {
        ...
        catch (Exception ex) { Log.Debug($"Reflect.TryGetMember: read failed for member '{name}' on {instance.GetType().Name}: {Log.ExceptionText(ex)}"); return false; }
    }
    ...
    public static bool SetMember(object instance, string name, object value)
    {
        ...
        catch (Exception ex) { Log.Debug($"Reflect.SetMember: write failed for member '{name}' on {instance.GetType().Name}: {Log.ExceptionText(ex)}"); return false; }
    }
